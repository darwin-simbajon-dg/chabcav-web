...
const BasicInfo: React.FC = () => {
  ...
  const provincesByCountry: { [key: string]: string[] }= {
    Philippines: ['Ilocos Norte', 'Ilocos Sur', 'La Union', 'Pangasinan', 'Benguet', 'Metro Manila', 'Cavite', 'Laguna', 'Batangas', 'Quezon', 'Rizal', 'Cebu', 'Davao del Sur', 'Bukidnon', 'Zamboanga del Sur'],
            ...
            <div className="row mt-4">
              <div className="col-6">
                <div className="input-group input-group-static">
                  ...
                  <select className="form-control" name="choices-location" id="choices-location" value={location} onChange={(e) => { setLocation(e.target.value); setProvince(''); }}>
                    ...
                    <div className="col-6">
                      <div className="input-group input-group-static">
                        ...
                        >
                          ...
                          {provincesByCountry[location].map((prov) => (
